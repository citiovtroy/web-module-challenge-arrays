...
function is31Flavors(iceCreamList){
    if (iceCreamList.length == 31){
        return true;
    } else {
        return false;
    }
...
function copy(newArrPlace, originalArr){

    newArrPlace = [...originalArr]
    return newArrPlace;

}

console.log(copy(newArr, originalFlavors));
